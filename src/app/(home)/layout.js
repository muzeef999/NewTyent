...
export const metadata = {
  ...
  title:
    "Tyent Water Ionizer - Best Alkaline Water Machine in India",
  description:
  ...
  openGraph: {
    ...
    description: "Explore Tyent water ionizers in India. Japanese technology, hydrogen-rich alkaline water. Find your model today.",
    url: "https://www.tyent.co.in/",
    images: "https://www.tyent.co.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fhome_Banner_Bg_Desktop.1a127905.png&w=3840&q=75",
  },
  twitter: {
...
{/* empty check */}
        ...
        {/* Structured Data Schemas - rendered server-side outside ClientComponent */}
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "@graph": [
              ...
              },
              {
                ...
                "name": "Tyent India",
                "inLanguage": "en-IN",
                "publisher": { "@id": "https://www.tyent.co.in/#organization" },
                "potentialAction": {
                  "@type": "SearchAction",
                  "target": { "@type": "EntryPoint", "urlTemplate": "https://www.tyent.co.in/?s={search_term_string}" },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "What is the Tyent Water Ionizer and how does it work?", "acceptedAnswer": { "@type": "Answer", "text": "Tyent Water Ionizer is a premium hydrogen-rich alkaline water system that uses advanced Japanese electrolysis technology to convert regular tap water into mineral-rich, antioxidant alkaline water. It helps improve hydration, neutralize acidity, and support overall health at a cellular level." } },
              { "@type": "Question", "name": "Is Tyent better than RO water purifiers?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Unlike RO systems that strip essential minerals and often leave water acidic, Tyent retains beneficial minerals while producing antioxidant, hydrogen-rich alkaline water. This delivers superior hydration, better taste, enhanced wellness support, and long-term protection." } },
              { "@type": "Question", "name": "What are the health benefits of drinking Tyent alkaline water?", "acceptedAnswer": { "@type": "Answer", "text": "Tyent hydrogen-rich alkaline water combines optimal alkalinity with selective antioxidant molecular hydrogen to neutralize acidity and reduce oxidative stress. It balances body pH, enhances digestion, boosts energy, supports immunity, and promotes long-term preventive health." } },
              { "@type": "Question", "name": "Is Tyent Water Ionizer safe for daily use?", "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. Tyent water ionizer systems are certified by USDA, KFDA, NSF, CE, ISO, EPA, ANSI and GMP standards, ensuring medical-grade safety, superior quality, and long-term reliability. Trusted in 123+ countries with a 40+ year legacy." } },
              { "@type": "Question", "name": "How is Tyent superior and more advanced than other water ionizers in the market?", "acceptedAnswer": { "@type": "Answer", "text": "Tyent features patented Japanese Solid Hybrid Mesh Plate Technology, patented SMPS PLUS power supply, and medical-grade components. It delivers higher molecular hydrogen, stable pH levels, superior durability, and consistent performance without chemicals." } },
              { "@type": "Question", "name": "How is Tyent Water Ionizer different from Tyent H2-Hybrid Hydrogen Generator?", "acceptedAnswer": { "@type": "Answer", "text": "Tyent Water Ionizers deliver 7 types of hydrogen-rich alkaline water from pH 2.5 to 11.5. The Tyent H2-Hybrid combines a water ionizer and hydrogen generator with a dedicated hydrogen button for high-concentration molecular hydrogen therapy at neutral pH." } },
              { "@type": "Question", "name": "What makes Tyent's Solid Hybrid Mesh Plates superior?", "acceptedAnswer": { "@type": "Answer", "text": "Tyent plates use 99.9% pure platinum-coated titanium, crafted with advanced Japanese technology from Permelac, Japan. They deliver superior durability, higher ORP levels, increased molecular hydrogen production, and are designed to last 45+ years." } },
              { "@type": "Question", "name": "What harmful contaminants does the Tyent's .01 micron dual-stage filtration remove?", "acceptedAnswer": { "@type": "Answer", "text": "The ultra-fine 0.01 micron dual-stage filtration removes over 200+ contaminants including heavy metals, chlorine, fluoride, industrial chemicals, pharmaceutical residues, nano-viruses, and nano-plastics. Certified by NSF, EPA and ANSI." } }
            ]
          }) }}
        />
        <script
