      ...
      <Container>
        <Row>
          ...
          >
            <div>
              <div style={{ width: "100%" }}>
                <Image src={maps} layout="responsive" priority alt="map" />
              </div>
            </div>
          </Col>
          <Col
          ...
          >
            ...
            <p className="text-center" data-aos="fade-up">
              Tyent stands as the most trusted water ionizer brand, celebrated
              for its unparalleled global presence in numerous countries
              surpassing any other competitor in the industry.
            </p>
            <div
              data-aos="zoom-in"
