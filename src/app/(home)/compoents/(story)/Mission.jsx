...
import apporach from "@/asserts/icons/apporach.png"
import Education from "@/asserts/icons/Education.png"
import health from "@/asserts/icons/health.png"
import Sustainability from "@/asserts/icons/Sustainability.png"
import Technology from "@/asserts/icons/Technology.png"
...
const Mission = () => {
  ...
  const waterTypes = [
        { icon:apporach, name:"To provide innovative water solutions that improve the health and well-being of individuals and families across India.", type: "Health & Wellness", color: "#000"},
        { icon:Sustainability, name:"To promote eco-friendly practices by reducing the dependency on single-use plastics and encouraging sustainable hydration.", type: "Sustainability", color: "#000" },
        { icon:Technology, name:"To continuously innovate and deliver cutting-edge water ionization and purification systems.", type: "Technology Leadership", color: "#000"},
        { icon:health, name:"To prioritize customer satisfaction by offering exceptional service, from product selection to after-sales support.", type: "Customer-Centric Approach", color: "#000"},
        { icon:Education, name:"To educate communities about the benefits of alkaline water and its role in fostering a healthier lifestyle.", type: "Education & Awareness", color: "#000"},
          ...
          {waterTypes.map((type, idx) => (
            ...
            >
              ...
              <div className='d-flex'> 
                <Image src={type.icon} alt="icon" width={25} height={25}/>
                <h6 className='mt-1'
                  style={{
                    color: `${type.color}`,
                    fontWeight: "700",
